...
import { FilteredVisitListener } from './FilteredVisitListener';
...
describe('<FilteredVisitListener/>', () => {
  ...
  it('is able to override how visit names are defined', async () => {
    ...
    await renderInTestApp(
      <TestApiProvider apis={[[visitsApiRef, mockVisitsApi]]}>
        <FilteredVisitListener visitName={visitNameOverride} />
      </TestApiProvider>,
      { routeEntries: [pathname] },
    );
  ...
  it('is able to override how entityRefs are defined', async () => {
    ...
    await renderInTestApp(
      <TestApiProvider apis={[[visitsApiRef, mockVisitsApi]]}>
        <FilteredVisitListener toEntityRef={toEntityRefOverride} />
      </TestApiProvider>,
      { routeEntries: [pathname] },
    );
